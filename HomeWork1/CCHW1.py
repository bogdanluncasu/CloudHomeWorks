...
TO_EMAIL="luncasub11@gmail.com"
FROM_EMAIL="tesapicc@gmail.com"
...
def create_email(to,sender,subject,message_text,file):
    ...
    server.login(FROM_EMAIL,"testapi22")
...
def get_service():
    ...
    save_random_image()
    save_meme(get_joke())
    create_email(TO_EMAIL,FROM_EMAIL,"Get your daily infos",msg,"meme.jpg")
